...
class CalculationController extends Controller
{
    ...
    public function calc(Request $request, Order $order)
    {
        ...
        $intakeStandardProperties = [
            [
                'エネルギー',
                'ENERC_KCAL',
                'ENERC_KCAL_' . $userData['sex'] . '_' . $userData['activeLevel']
            ],
            [
                'タンパク質',
                'PROT',
                'PROT_' . $userData['sex'] . '_' . $userData['activeLevel'] . '_MIN'
            ],
            [
                '脂質',
                'FAT',
                'FAT_' . $userData['sex'] . '_MIN'
            ],
            [
                '飽和脂肪酸',
                'SFA',
                'SFA_' . $userData['sex'] . '_MIN'
            ],
            [
                'n-6系脂肪酸',
                'N6PUFA',
                'N6PUFA_' . $userData['sex']
            ],
            [
                'n-3系脂肪酸',
                'N3PUFA',
                'N3PUFA_' . $userData['sex']
            ],
            [
                '炭水化物',
                'CHOCDF',
                'CHOCDF_' . $userData['sex'] . '_MIN'
            ],
            [
                '食物繊維',
                'FIB',
                'FIB_' . $userData['sex'] . '_MIN'
            ],
            [
                'ビタミンA',
                'VITA',
            ...
            [
                'ビタミンB6',
                'VITB6A',
                'VITB6A_' . $userData['sex']
            ],
            [
                'ビタミンB12',
                'VITB12',
                'VITB12_' . $userData['sex']
            ],
            [
                '葉酸',
                'FOL',
        ...
        // 食材のデータ取得ここまで
        return view('order.calc')
        ->with('tableVisibility', [
            'default' => 'block',
            'mineral' => 'none',
            'vitamin' => 'none',
            'all' => 'none',
        ])
        ->with('initialChecked', old('btn', 'default'))
        ->with('selectedOption', old('btn', $selectedOption))
        ->with('intakeNutritionsTotal', $intakeNutritionsTotal)
        ->with('intakeStandardProperties', $intakeStandardProperties)
        ->with('userStandardValue', $userStandardValue);
    }
    ...
    public function calcRequest(Request $request)
    {
        ...
        $selectedOption = $request->input('btn');
