		...
		<div class="flex flex-wrap -mx-4">
			<div class="w-full px-4">
				<div class="text-center mx-auto mb-[60px] lg:mb-20 max-w-[510px]">
					<h2 class="font-bold text-3xl sm:text-4xl md:text-[40px] text-green-700 mb-4">下記の食材を削除しました。</h2>
					...
					<div class="flex between w-1/2 mx-auto my-0">
                        <button type="button" onclick="window.location='{{ route('order.index') }}'" class="mt-8 p-4 bg-green-800 text-white w-full max-w-xs hover:bg-green-900 transiton-colors">一覧に戻る</button>
            		</div>
				</div>
			</div>
		</div>
