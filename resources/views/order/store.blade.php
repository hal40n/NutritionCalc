			...
			<div class="w-full px-4">
				<div class="text-center mx-auto mb-[60px] lg:mb-20 max-w-[510px]">
					...
					<div class="flex between w-1/2 mx-auto my-0">
                        <button type="button" onclick="window.location='{{ route('order.create') }}'"  class="mt-8 p-4 bg-gray-500 text-white w-full max-w-xs hover:bg-green-900 transiton-colors mr-3">続けて登録</button>
                        <button type="button" onclick="window.location='{{ route('order.index') }}'" class="mt-8 p-4 bg-green-800 text-white w-full max-w-xs hover:bg-green-900 transiton-colors">一覧</button>
            		</div>
				</div>
			</div>
		</div>
